SELECT  sa.id id, sa.created_at created_at, sa.updated_at updated_at, sa.deleted_at deleted_at, sa.disabled disabled, 
        r.naziv naziv_restoran, sa.skladiste_id skladiste_id, sa.naziv naziv, sa.cijena cijena, sa.kolicina_tip kolicina_tip, 
        sa.slika slika, sa.potrebna_kolicina potrebna_kolicina, sa.trenutna_kolicina trenutna_kolicina
FROM sastojak sa
