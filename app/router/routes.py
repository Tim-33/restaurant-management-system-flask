...
class ZaposlenikRoutesEnum(Enum):
    ...
    ZAPOSLENIK_NEZGODE = "/zaposlenici/nezgode"
...
class JelovnikRoutesEnum(Enum):
    ...
    JELOVNIK_STAVKE_TIPA_JELA = "/jelovnici/stavke-tipa-jela"
...
class SastojakRoutesEnum(Enum):
    ...
    SASTOJAK_MOST_COMMON = "/sastojci/most-common"
