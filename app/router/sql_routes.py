...
class SastojakSqlRoutesEnum(Enum):
    ...
    SELECT_MOST_COMMON = 'sql/sastojak/select-most-common.sql'
    SELECT_BY_MALA_NEZGODA_WITH_TOTAL = 'sql/sastojak/select-by-mala-nezgoda-with-total.sql'
...
class MalaNezgodaSqlRoutesEnum(Enum):
    ...
    SELECT_DETAILS = 'sql/mala_nezgoda/select-details.sql'
    INSERT_BY_TRANSACTION = 'sql/mala_nezgoda/insert-by-transaction.sql'
